...
import type { InputBaseProps } from '@burro/shared/components/base/input/input';
import { InputBase, TextField } from '@burro/shared/components/base/input/input';
...
import {
  ...
  UnionPayIcon,
  VisaIcon,
} from '@burro/shared/components/foundations/payment-icons';
