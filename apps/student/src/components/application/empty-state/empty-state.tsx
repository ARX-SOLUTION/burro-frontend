...
import { FeaturedIcon as FeaturedIconbase } from '@burro/shared/components/foundations/featured-icon/featured-icon';
import type { BackgroundPatternProps } from '@burro/shared/components/shared-assets/background-patterns';
import { BackgroundPattern } from '@burro/shared/components/shared-assets/background-patterns';
import { Illustration as Illustrations } from '@burro/shared/components/shared-assets/illustrations';
