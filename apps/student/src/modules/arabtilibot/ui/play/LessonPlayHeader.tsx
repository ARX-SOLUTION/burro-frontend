...
export const LessonPlayHeader = memo(
  ({ progressPercent, hearts, xpText, closeAriaLabel, onClose }: LessonPlayHeaderProps) => {
    return (
...
LessonPlayHeader.displayName = 'LessonPlayHeader';
