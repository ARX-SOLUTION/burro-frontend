import type { ComponentPropsWithRef, FC, HTMLAttributes, ReactNode } from 'react';
...
import type { BadgeColors } from '@burro/shared/components/base/badges/badge-types';
