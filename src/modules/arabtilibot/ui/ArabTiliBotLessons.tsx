    ...
    <div className="min-h-screen bg-gray-100">
      <div className="mx-auto min-h-screen w-full max-w-[448px] bg-gray-50 shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)]">
        <div className="sticky top-0 z-20 bg-white px-4 py-3 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-[14px] leading-[20px] font-bold text-gray-800">
                  Salom, Azizbek 👋
                </p>
            ...
            <div className="rounded-full bg-gray-100 px-3 py-1 text-[12px] leading-[16px] font-bold text-[#4b5563]">
              🇬🇧 EN
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6 px-4 py-4 pb-28">
          <div className="relative h-[212px] overflow-hidden rounded-2xl bg-teal-600 p-5 shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]">
          ...
          <div className="flex items-center justify-between rounded-2xl border border-gray-100 bg-white p-4 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]">
            <div>
              <p className="text-[12px] leading-[16px] font-bold text-gray-400 uppercase">
                Kunlik vazifa
              </p>
              <p className="mt-1 text-[16px] leading-[24px] font-bold text-gray-800">
                10 ta savol yechin
              </p>
            </div>
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]">
            <div className="flex items-center justify-between">
              <p className="text-[16px] leading-[24px] font-bold text-gray-800">Bugungi natij</p>
              <button
                type="button"
                className="text-[12px] leading-[16px] font-bold text-teal-600"
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              <div className="rounded-xl bg-[#f9fafb] p-3">
                <p className="text-[12px] leading-[16px] text-gray-400">Vaqt</p>
                <p className="mt-1 text-[18px] leading-[28px] font-bold text-gray-800">180 min</p>
              </div>
              <div className="rounded-xl bg-[#f9fafb] p-3">
                <p className="text-[12px] leading-[16px] text-gray-400">XP</p>
                <p className="mt-1 text-[18px] leading-[28px] font-bold text-gray-800">1240</p>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="mb-3 flex items-center justify-between">
              <p className="text-[16px] leading-[24px] font-bold text-gray-800">Modullar</p>
              <button
                type="button"
                className="text-[12px] leading-[16px] font-bold text-teal-600"
            ...
            <div className="-mx-4 overflow-x-auto px-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              <div className="flex gap-3 pb-1">
                {dashboardModules.map((module) => (
                  ...
                  >
                    <p className="text-[30px] leading-[36px] font-bold text-gray-800">
                      {module.title}
                    </p>
                    <p className="mt-2 text-[12px] leading-[16px] text-gray-500">
                      {module.description}
                    </p>
                    ...
                    {module.locked && (
                      <span className="absolute inset-0 flex items-center justify-center rounded-xl bg-[#f3f4f680]">
                        <Lock01 className="size-6 text-gray-500" />
                      </span>
                    )}
                  </button>
                ))}
        ...
        <div className="fixed inset-x-0 bottom-0 z-30 flex justify-center">
          <div className="relative w-full max-w-[448px] border-t border-gray-200 bg-white">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
              <Button
                color="tertiary"
                className="size-16 rounded-full border-4 border-gray-100 bg-teal-600 p-0 text-white hover:bg-teal-600 hover:text-white"
                onClick={handleStartLesson}
